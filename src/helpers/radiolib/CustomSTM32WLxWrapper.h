...
class CustomSTM32WLxWrapper : public SX126xDutyCycleWrapper {
public:
  CustomSTM32WLxWrapper(CustomSTM32WLx& radio, mesh::MainBoard& board) : SX126xDutyCycleWrapper(radio, board) { }
